...
import VercelEnv from "@images/envariables.png"
...
<BlogImage src={CreateProject} alt="Create Project in Supabase" />
...
<BlogImage src={VercelEnv} alt="Vercel Environment Variables" />
